...
if (numero1 > numero2) {
document.getElementById('maggiore').innerHTML = 'Il numero piu grande e' + numero1;
}else if (numero2 > numero2) {
  document.getElementById('maggiore').innerHTML = 'Il numero piu grande e' + numero2;
}else {
...
document.getElementById('notequal').innerHTML = 'Il numero e diverso da 5';
} else {
  document.getElementById('notequal').innerHTML = 'Il numero e uguale a 5';
}
...
if(diviso5 % 5 === 0) {
  ...
  document.getElementById('diviso5').innerHTML = 'Il numero e divisible per 5';
}else {
  document.getElementById('diviso5').innerHTML = 'Il numero non e divisible per 5';
}
...
document.getElementById('totale').innerHTML= 'Costo Totale: EUR' + totale;
...
document.getElementById('black').innerHTML= 'Costo Totale: EUR' +  totale2;
